...
# Print the coordinates, distance, and phone numbers of the 3 nearest help stations
print("\nThe 3 nearest help stations with their details are:")
for i, ((station, phone), dist) in enumerate(nearest_stations):
    print(f"\nHelp Station {i+1}:")
    print(f"Coordinates: {station}")
    print(f"Distance: {dist:.2f} km")
    print(f"Phone Number: {phone if phone else 'No contact info'}")
